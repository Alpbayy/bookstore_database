                        ...
                        <tbody>
                            ...
                            foreach ($_SESSION['cart'] as $isbn => $item) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="includes/update-cart.php" method="POST" style="display: inline;">
                                    ...
                                    <td>
                                        <a href="includes/remove-from-cart.php?isbn=<?php echo urlencode($isbn); ?>" class="btn btn-sm btn-danger">
