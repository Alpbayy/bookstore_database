                ...
                <div class="books-grid">
                    ...
                    try {
                        ...
                        if (count($books) > 0) {
                            ...
                            echo '<div class="no-books"><p>No books found. Try a different search or category.</p></div>';
                        }
                    } catch(Exception $e) {
                        echo '<div class="error-message"><p>Error loading books: ' . htmlspecialchars($e->getMessage()) . '</p></div>';
                    }
                    ?>
                </div>
            </div>
